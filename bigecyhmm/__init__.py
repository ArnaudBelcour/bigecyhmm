...
MOTIF_PAIR = {'dsrE': 'tusD',
    ...
    'hydrogenase_NiFeGroup1l': ['hydrogenase_NiFeGroup1h'], 
    'hydrogenase_NiFeGroup1h': ['hydrogenase_NiFeGroup1l'],
    'hydrogenase_FeFeGroupA1': ['hydrogenase_FeFeGroupA2', 'hydrogenase_FeFeGroupA4','hydrogenase_FeFeGroupA3'],
    #'hydrogenase_FeFeGroupA2': ['hydrogenase_FeFeGroupA1', 'hydrogenase_FeFeGroupA3', 'hydrogenase_FeFeGroupA4'],
    'hydrogenase_FeFeGroupA3': ['hydrogenase_FeFeGroupA1','hydrogenase_FeFeGroupA2', 'hydrogenase_FeFeGroupA4'],
    #'hydrogenase_FeFeGroupA4': ['hydrogenase_FeFeGroupA1', 'hydrogenase_FeFeGroupA2', 'hydrogenase_FeFeGroupA3'],
