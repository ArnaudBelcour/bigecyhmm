...
drawNcycle.single <- function(R_input, OutputFolder){
  ...
  straightarrow(from = elpos[6, ], to = elpos[3, ], lty = 1, lcol = input[18,2])#N-S-08:Nitrite ammonification
  splitarrow(from = elpos[c(3,6), ], to = elpos[1, ], lty = 1, lwd = 1, dd = 0.7, arr.side = 1:2, lcol = input[19,2]) #N-S-09:Anammox
  straightarrow(from = elpos[4, ], to = elpos[1, ], lty = 1, lcol = input[20,2]) #N-S-10:Nitric oxide dismutase
  ...
  textplain(mid = c(0.55, 0.70), 
            lab = c("Step9: Anammox"))
  textplain(mid = c(0.42, 0.78),
            lab = c("Step10: Nitric oxide dismutase"))
...
drawNcycle.total <- function(R_input, OutputFolder){
  ...
  straightarrow(from = elpos[1, ], to = elpos[3, ], lty = 1, lcol = 'deeppink3') #N-S-01:Nitrogen fixation
  straightarrow(from = elpos[3, ], to = elpos[7, ], lty = 1, lcol = 'cyan3') #N-S-02:Ammonia oxidation
  straightarrow(from = elpos[7, ], to = elpos[8, ], lty = 1, lcol = 'darkorange4') #N-S-03:Nitrite oxidation
  straightarrow(from = elpos[8, ], to = elpos[6, ], lty = 1, lcol = 'dodgerblue4') #N-S-04:Nitrate reduction
  straightarrow(from = elpos[6, ], to = elpos[4, ], lty = 1, lcol = 'dodgerblue4') #N-S-05:Nitrite reduction
  straightarrow(from = elpos[4, ], to = elpos[2, ], lty = 1, lcol = 'dodgerblue4') #N-S-06:Nitric oxide reduction
  straightarrow(from = elpos[2, ], to = elpos[1, ], lty = 1, lcol = 'dodgerblue4') #N-S-07:Nitrous oxide reduction
  straightarrow(from = elpos[6, ], to = elpos[3, ], lty = 1, lcol = 'cadetblue') #N-S-08:Nitrite ammonification
  splitarrow(from = elpos[c(3,6), ], to = elpos[1, ], lty = 1, lwd = 1, dd = 0.7, arr.side = 1:2, lcol = 'chartreuse3') #N-S-09:Anammox
  straightarrow(from = elpos[4, ], to = elpos[1, ], lty = 1, lcol = 'darkorchid3') #N-S-10:Nitric oxide dismutase
...
drawScycle.single <- function(R_input, OutputFolder){
  ...
  elpos
  curvedarrow(from = elpos[1, ], to = elpos[4, ], curve = -0.1, lty = 1, lcol = input[26,2]) #S-S-01:Sulfide oxidation
  curvedarrow(from = elpos[4, ], to = elpos[1, ], curve = -0.1, lty = 1, lcol = input[27,2]) #S-S-02:Sulfur reduction
  straightarrow(from = elpos[4, ], to = elpos[10, ], lty = 1, lcol = input[28,2]) #S-S-03:Sulfur oxidation
  straightarrow(from = elpos[10, ], to = elpos[11, ], lty = 1, lcol = input[29,2]) #S-S-04:Sulfite oxidation
  straightarrow(from = elpos[11, ], to = elpos[5, ], lty = 1, lcol = input[30,2]) #S-S-05:Sulfate reduction
  straightarrow(from = elpos[5, ], to = elpos[1, ], lty = 1, lcol = input[31,2]) #S-S-06:Sulfite reduction
  straightarrow(from = elpos[6, ], to = elpos[11, ], lty = 1, lcol = input[32,2]) #S-S-07:Thiosulfate oxidation
  splitarrow(from = elpos[6, ], to = elpos[c(1,10), ], lty = 1, lwd = 1, dd = 0.7, arr.side = 1:2, lcol = input[33,2]) #S-S-08:Thiosulfate disproportionation
  splitarrow(from = elpos[6, ], to = elpos[c(4,11), ], lty = 1, lwd = 1, dd = 0.7, arr.side = 1:2, lcol = input[34,2]) #S-S-09:Thiosulfate disproportionation 2
...
drawScycle.total <- function(R_input, OutputFolder){
  ...
  curvedarrow(from = elpos[1, ], to = elpos[4, ], curve = -0.1, lty = 1, lcol = 'darkorange2') #S-S-01:Sulfide oxidation
  curvedarrow(from = elpos[4, ], to = elpos[1, ], curve = -0.1, lty = 1, lcol = 'cadetblue3') #S-S-02:Sulfur reduction
  straightarrow(from = elpos[4, ], to = elpos[10, ], lty = 1, lcol = 'darkorchid3') #S-S-03:Sulfur oxidation
  straightarrow(from = elpos[10, ], to = elpos[11, ], lty = 1, lcol = 'darkolivegreen3') #S-S-04:Sulfite oxidation
  straightarrow(from = elpos[11, ], to = elpos[5, ], lty = 1, lcol = 'saddlebrown') #S-S-05:Sulfate reduction
  straightarrow(from = elpos[5, ], to = elpos[1, ], lty = 1, lcol = 'saddlebrown') #S-S-06:Sulfite reduction
  straightarrow(from = elpos[6, ], to = elpos[11, ], lty = 1, lcol = 'deepskyblue4') #S-S-07:Thiosulfate oxidation
  splitarrow(from = elpos[6, ], to = elpos[c(1,10), ], lty = 1, lwd = 1, dd = 0.7, arr.side = 1:2, lcol = 'deepskyblue4') #S-S-08:Thiosulfate disproportionation 1
  splitarrow(from = elpos[6, ], to = elpos[c(4,11), ], lty = 1, lwd = 1, dd = 0.7, arr.side = 1:2, lcol = 'deepskyblue4') #S-S-09:Thiosulfate disproportionation 2
...
drawCcycle.total <- function(R_input, OutputFolder){
  ...
  curvedarrow(from = elpos[8, ], to = elpos[1, ], curve = -0.5, lty = 1, lcol = 'snow4') #C-S-02:Carbon fixation
  ...
  straightarrow(from = elpos[1, ], to = elpos[4, ], lty = 1, lcol = 'gold4') #C-S-05:Hydrogen generation
  straightarrow(from = elpos[2, ], to = elpos[3, ], lty = 1, lcol = 'gold4') #C-S-06:Fermentation
  straightarrow(from = elpos[3, ], to = elpos[2, ], lty = 1, lcol = 'gold4') #C-S-06:Fermentation
  straightarrow(from = elpos[4, ], to = elpos[7, ], lty = 1, lcol = 'mediumpurple4') #C-S-07:Methanogenesis
  curvedarrow(from = elpos[2, ], to = elpos[7, ], curve = 0.2, lty = 1, lcol = 'mediumpurple4') #C-S-07:Methanogenesis
  curvedarrow(from = elpos[7, ], to = elpos[8, ], curve = 0.1, lty = 1, lcol = 'wheat3') #C-S-08:Methanotrophy
  curvedarrow(from = elpos[8, ], to = elpos[7, ], curve = 0.1, lty = 1, lcol = 'mediumpurple4') #C-S-07:Methanogenesis
  straightarrow(from = elpos[4, ], to = elpos[6, ], lty = 1, lcol = 'lightpink2') #C-S-09:Hydrogen oxidation
  straightarrow(from = elpos[4, ], to = elpos[2, ], lty = 1, lcol = 'turquoise4') #C-S-10:Acetogenesis
  curvedarrow(from = elpos[8, ], to = elpos[2, ], curve=0.22, lty = 1, lcol = 'turquoise4') #C-S-10:Acetogenesis
...
drawOthercycles.single<- function(R_input, OutputFolder){
  ...
  elpos
  curvedarrow(from = elpos[2, ], to = elpos[7, ], curve = 0.1, lty = 1, lcol = input[21,2]) #O-S-01:Iron reduction
  curvedarrow(from = elpos[7, ], to = elpos[2, ], curve = 0.1, lty = 1, lcol = input[22,2]) #O-S-02:Iron oxidation
  ...
  straightarrow(from = elpos[12, ], to = elpos[14, ], lty = 1, lcol = input[25,2]) #O-S-05:Selenate reduction
...
drawOthercycles.total<- function(R_input, OutputFolder){
  ...
  elpos <- coordinates (c(5, 5, 2, 2)) # Put the coordinate
  elpos
  curvedarrow(from = elpos[2, ], to = elpos[7, ], curve = 0.1, lty = 1, lcol = 'darkgreen') #O-S-01:Metal reduction
  curvedarrow(from = elpos[7, ], to = elpos[2, ], curve = 0.1, lty = 1, lcol = 'darkgreen') #O-S-02:Iron oxidation
  curvedarrow(from = elpos[11, ], to = elpos[13, ], curve = 0.1, lty = 1, lcol = 'darkorange3') #O-S-03:Arsenate reduction
  curvedarrow(from = elpos[13, ], to = elpos[11, ], curve = 0.1, lty = 1, lcol = 'darkorange3') #O-S-04:Arsenite oxidation
  ...
  textplain(mid = c(0.15, 0.75), col = 'darkgreen',
            lheight=0.5,
  ...
  textplain(mid = c(0.43, 0.75), col = 'darkgreen',
            lheight=0.5,
  ...
  textplain(mid = c(0.1, 0.25), col = 'darkorange3',
  ...
  textplain(mid = c(0.4, 0.25), col = 'darkorange3',
